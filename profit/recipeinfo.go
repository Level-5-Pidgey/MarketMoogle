...
func getRecipes(item *csvType.Item, collection *datacollection.DataCollection) (*[]RecipeInfo, error) {
...
func getRecipeIngredientsForItem(recipe csvType.Recipe) []RecipeIngredients {
